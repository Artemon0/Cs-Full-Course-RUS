...
namespace MyLearn.Module02_OOP
{
    ...
    // Interface определяет контракт - что должен уметь класс
    ...
    public class InterfacesDemo
    {
        ...
        {
            Console.WriteLine("=== Lesson 3: Interfaces and Abstract Classes ===\n");
 ...
 * ========================================
 * 
 * 1. Interface vs Абстрактный класс:
 *    
 *    Interface:
 ...
 *    - Только одиночное inheritance
 *    - Может иметь поля и конструкторы
 * 
 * 2. Когда использовать interfaces:
 *    - Определение контракта
 *    - Множественная реализация нужна
 *    - Несвязанные classes должны иметь общее поведение
 * 
 * 3. Когда использовать абстрактные classes:
 *    - Общая реализация для наследников
 *    - Тесно связанные classes
 *    - Нужны поля и конструкторы
 * 
 * 4. Именование:
 *    - Interfaceы начинаются с I
