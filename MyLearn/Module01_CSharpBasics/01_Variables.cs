...
{
    /// <summary>
    /// Урок 1: Переменные и типы данных в C#
    /// 
    ...
    public class Variables
    {
        ...
        {
            Console.WriteLine("=== Урок 1: Переменные и типы данных ===\n");
 ...
 * ========================================
 * 
 * 1. Создайте переменные для системы инвентаря:
 ...
 * 
 * 2. Создайте переменные для характеристик персонажа:
 ...
 * 
 * 4. Создайте переменные для оружия:
